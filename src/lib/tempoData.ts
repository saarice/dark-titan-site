...
export const GAP = 1300; // cadence of new tickets entering Planned
export const T_PROGRESS = 2200; // born -> In Progress
export const T_DONE = 3900; // born -> Done
export const T_REMOVE = 8400; // born -> aged out of Done
export const LIFT_MS = 760; // how long a card stays "lifted" after a move
export const WARMUP = 7200; // pre-roll so the board starts fully populated
