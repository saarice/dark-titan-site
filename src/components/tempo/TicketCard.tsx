...
import { TAG_TOKEN, TAG_LABEL, type Card } from "../../lib/tempoData";
 ...
 * cursor: the drag-and-drop feel is entirely automated. Cards fade in when
 * born into Planned and fade out when they age off Done (via AnimatePresence).
 */
export default function TicketCard({
  ...
  const token = TAG_TOKEN[card.tag];
